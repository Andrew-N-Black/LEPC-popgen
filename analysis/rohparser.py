...
path_to_directory = "/scratch/gautschi/blackan/GROUSE/nexus/roh/"

#Estimate ROH based on "PL"
roh_input = path_to_directory  + sample
roh_output = path_to_directory + "_PL.txt"
ref_index_file = "/scratch/gautschi/blackan/GROUSE/nexus/ref/GCF_026119805.1_pur_lepc_1.0_genomic.fna.fai"

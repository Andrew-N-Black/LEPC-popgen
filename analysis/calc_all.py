...
def calculate_distances(var_file, paf_file):
    ...
    #calculate proportions of transitions, transversions, and total differences
    ...
    #write distances to the output CSV file
...
if __name__ == "__main__":
    ...
    #call the function with the input file paths (input_file1 = .var.txt, input_file2 = .srt.paf)
